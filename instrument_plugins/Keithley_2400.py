...
# --------------------------------------
    ...
    def do_get_readlastval(self):
        ...
        text = self._visainstrument.ask(':MEAS?')
        return float(text[0:15])
    ...
    def do_set_source_voltage(self,val):
        logging.debug('Set source voltage to %s' % val)
        self._set_func_par_value('SOUR', 'VOLT', val)
