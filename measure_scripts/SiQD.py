# File name: SiQD.py
# (based on 'measure_module.py')

# For intro see 'measure_module.py','basic_measurement.py'
# To load this module: 'import SiQD_measure_module'
